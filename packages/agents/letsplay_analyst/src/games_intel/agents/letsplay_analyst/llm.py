...
from games_intel.agents.letsplay_analyst.exceptions import LlmStructureError
...
def coerce_conclusion(result: Any) -> LetsPlayConclusion:
    if isinstance(result, LetsPlayConclusion):
        return result
    return LetsPlayConclusion.model_validate(result)
...
class FakeStructuredChatModel:
    """Test double: queued LetsPlayConclusion or errors."""
